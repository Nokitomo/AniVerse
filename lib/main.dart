...
import 'package:aniverse/ui/pages/main_page.dart';
import 'package:aniverse/ui/theme/theme_builder.dart';
...
void main() async {
  ...
  final scAuthService = StreamingCommunityAuthService();
  Get.put(scAuthService);
