# Agent Rules (AniVerse)

These rules are mandatory for any work on this repository.

1) After every change to any file, run git and create a commit that records the change.
