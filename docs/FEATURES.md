...
- Carosello in Home con selezione settimanale di anime (popolari, ultimi, top rating), solo con banner, preferenza per versioni (ITA), cache persistente e prefetch immagini (iniziale + background)
